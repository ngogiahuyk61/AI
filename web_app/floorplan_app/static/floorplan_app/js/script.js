...
(function(){
  ...
  function drawAxes(ctx){
    ...
    for(let val = majorStepMm; val <= LOGICAL_SIZE; val += majorStepMm){
      ...
      ctx.fillText(String(val), labelX - 18, CANVAS_MARGIN + DRAW_SIZE + 18);
      ctx.fillText(String(val), CANVAS_MARGIN - 46, labelY + 4);
    }

    ctx.fillText('x (mm)', CANVAS_MARGIN + DRAW_SIZE + 26, CANVAS_MARGIN + DRAW_SIZE + 18);
    ctx.save();
    ctx.translate(CANVAS_MARGIN - 44, CANVAS_MARGIN - 8);
