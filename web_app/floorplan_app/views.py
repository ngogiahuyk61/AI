...
def payment_view(request):
    # Lấy tham số 'plan' từ URL (ví dụ: /payment/?plan=pro -> plan_type = 'pro')
    plan_type = request.GET.get('plan', 'free') # Mặc định là free nếu không có tham số
    
    # Định nghĩa thông tin hiển thị dựa trên gói
    context = {
        'plan_type': plan_type,
        'price': '0',
        'tokens': '0'
    ...
    # Render template payment.html
    return render(request, 'floorplan_app/payment.html', context)